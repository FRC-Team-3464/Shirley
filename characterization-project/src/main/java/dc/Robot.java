...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    CANSparkMax leftMotor = setupCANSparkMax(4, Sides.LEFT, true);
    ...
    CANSparkMax rightFollowerID7 = setupCANSparkMax(7, Sides.FOLLOWER, false);
    rightFollowerID7.follow(rightMotor, false);
