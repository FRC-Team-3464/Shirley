...
public class ExtenderSimpleSetPositionCommand extends CommandBase {
  ...
  public ExtenderSimpleSetPositionCommand(ExtenderSubsystem ExtenderSubsystem, double target) {
    setpoint = target;
  ...
  public void initialize() {
    ...
    extenderSub.resetElevatorEncoder();
  }
